(() => {
    ...
    function initSliders() {
        if (document.querySelector(".members__slider")) new core(".members__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".members__button_prev",
                nextEl: ".members__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".gallery-project__slider")) new core(".gallery-project__slider_main", {
            ...
            thumbs: {
                swiper: {
                    el: ".gallery-project__slider_thumbnail",
                    freeMode: true,
                    spaceBetween: 10,
                    slidesPerView: 4
                }
            ...
            effect: "fade",
            navigation: {
                prevEl: ".gallery-project__button_prev",
                nextEl: ".gallery-project__button_next"
            }
        });
    ...
    function swiperSmall() {
        if (document.querySelector(".swiper-small")) if (window.innerWidth <= 768) {
            if (!init) {
                init = true;
                sliderServices = new core(".swiper-small", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    loop: false,
                    navigation: {
                        prevEl: ".items-block-services__button_prev",
                        nextEl: ".items-block-services__button_next"
                    },
                    on: {}
                });
            }
